                ...
                @foreach($summaries ?? [] as $model)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('app.transaction.index', ['date_from' => $model->group_date, 'date_to' => $model->group_date, 'account_id' => $model->account_id]) }}" class=" text-hover-primary text-primary mb-1">
                                Detail
                            </a>
                        </td>
                    </tr>
