        ...
        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_customers_table">
            ...
            <tbody class="fw-semibold text-gray-600">
                ...
                <tr>
                    ...
                    <td>
                        <span
                            class="badge badge-{{ $transaction->type == \App\Enums\Transaction\TransactionType::INCOME->value ? 'success' : 'danger' }}">
                            {{ $transaction->type }}
                        </span>
                    </td>
                    <td>
                        {{ \App\Enums\Account\Currency::tryFrom($transaction->account->currency)->prefix(). ' '.
                        number_format($transaction->amount) }}
                    </td>
                    <td>
                        {{ \Illuminate\Support\Carbon::parse($transaction->created_at)->format('d M Y, h:i A') }}
                    </td>
                    <td>
                    ...
                    <td class="text-end">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4"
                            ...
                            <div class="menu-item px-3">
                                <a href="{{ route('app.transaction.edit', ['transaction' => $transaction->id]) }}" class="menu-link px-3">
                                    Edit
                                </a>
                            </div>
                            <!--end::Menu item-->
